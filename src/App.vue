<template>
  <v-app id="inspire">
    <v-navigation-drawer v-model="drawer" app>
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title class="title">Admin Control Panel</v-list-item-title>
      ...
      <v-card>
        <v-list>
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title>{{ appData.firstname }} {{appData.lastname}}</v-list-item-title>
...
export default {
  ...
  methods: {
    updatePage: function(moduleName) {
