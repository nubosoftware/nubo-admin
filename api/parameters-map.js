...
var filter = {
    "rules": [{
        ...
        "path": "/loadUIDs",
        "constraints": {
            "lastUid": constraints.packageUIDConstrOptional,
            "platformID": constraints.platIdConstrRequested,
            "platformUID": constraints.requestedPlatformUIDConstr
        }
    }, {
        "path": "/saveUIDs",
        "constraints": {
            "force": constraints.binaryBoolConstrRequested,
            "platformID": constraints.platIdConstrRequested,
            "packageName": constraints.packageNameConstrOptional,
            "uid": constraints.packageUIDConstrOptional,
            "sharedUid": constraints.boolConstrOptional,
            "platformUID": constraints.requestedPlatformUIDConstr
        }
    }, {
        "path": "/cp/getOUs",
        ...
        "path": "/cp/setupAD",
        "constraints": {
            "host": constraints.serverUrlConstrRequested,
            "user": constraints.userNameConstrRequested,
            ...
            "sync": constraints.boolConstrRequested,
            "adDomain": constraints.adDomainNameConstrRequested,
            "SSL": {
                "presence": true,
                "inclusion": {
                    "within": ["auto", "ldaps://", "ldap://"]
                }
            }
        },
        "headerConstraints": {
        ...
        "constraints": {
            ...
            "password": constraints.passcodeConstrRequested,
            "serverName": constraints.serverUrlConstrRequested,
            "serverPort": constraints.portNumberConstrRequested,
            "secureSSL": constraints.binaryBoolConstrRequested,
    ...
    },
    {
        ...
        "constraints": {
            ...
            "versionCode": constraints.NaturalNumberConstrRequested,
            "appName": constraints.freeFieldRequested,
            "appDescription": constraints.ExcludeSpecialCharactersOptional,
            "apkUpdateDescription": constraints.ExcludeSpecialCharactersOptional
        },
        "headerConstraints": {
            "controlpanelid": constraints.controlPanelIDConstrOptional
        },
        ...
        "path": "/cp/setupExchange",
        "constraints": {
            "serverUrl": constraints.serverUrlConstrRequested,
            "port": constraints.portNumberConstrRequested,
            "sslType": constraints.binaryBoolConstrRequested
        },
        "headerConstraints": {
            "controlpanelid": constraints.controlPanelIDConstrOptional
        },
        ...
        "path": "/checkStreamFile",
        "constraints": {
            "loginToken": constraints.requestedLoginTokenConstr,
            "streamFileName": constraints.pathConstrRequested
        },
        "headerConstraints": {
            'fe-user': constraints.ExcludeSpecialCharactersRequested,
            'fe-pass': constraints.passcodeConstrRequested
        ...
        "path": "/playPauseStream",
        "constraints": {
            "sessionId": constraints.sessionIdConstrRequested,
            "fileName": constraints.pathConstrRequested,
            "isLiveStream": constraints.boolConstrRequested,
            "playOrPause": {
                "presence": true,
                "inclusion": {
                    "within": ["play", "pause"]
        ...
        "path": "/createStream",
        "constraints": {
            "outputfile": constraints.pathConstrRequested,
            "fileType": {
                "presence": true,
                "inclusion": {
                    "within": ["0", "1", "2", "3", "4", "5"]
            ...
            "url": constraints.mediaStreamRequested,
            "FPSLevel": {
                "presence": true,
                "inclusion": {
                    "within": ["50", "100", "200"]
        ...
        "constraints": {
            "loginToken": constraints.requestedLoginTokenConstr,
            "streamFileName": constraints.packageNameConstrRequested,
        ...
        "path": "/cp/installURLLauncher",
        "constraints": {
            "appURL": constraints.urlConstrRequested,
            "appName": {
                "presence": true,
                "format": "^[a-zA-Z0-9\\-\_\/\+\=\\n]+$"
            },
            "ssoURL": constraints.urlConstrRequested,
            "OrientationMode": {
                "presence": true,
                "inclusion": ["0", "1", "2"]
            }
        ...
        "path": "/settings/getOpenVpnConfig",
        "headerConstraints": {
            "nubosettingsid": constraints.settingsIDConstrRequested
        },
        "bodyConstraints": {
        ...
        "path": "/settings/updateUserVpnState",
        "constraints": {
            "state": constraints.NaturalNumberConstrRequested
        },
        "headerConstraints": {
            "nubosettingsid": constraints.settingsIDConstrRequested
        },
        ...
        "path": "/settings/addOpenVpnProfile",
        "constraints": {}
    }, {
        "path": "/checkPasscode",
        "constraints": {
        ...
        "constraints": {
            "sessionid": constraints.sessionIdConstrOptional,
            "loginToken": constraints.requestedLoginTokenConstr,
            "user": constraints.userNameConstrOptional,
            "password": constraints.passcodeConstrRequested
        },
        "headerConstraints": {
            'x-client-ip': constraints.ipConstrRequested,
        ...
        "path": "/createTrialProd",
        "constraints": {
            "email": constraints.emailConstrRequested,
            "forceAdmin": constraints.Y_N_boolConstrOptional
        }
    }, {
